...
def rename_colorblock_file(importFolder="./import", exportFolder="./export"):
    for fichier in listdir(importFolder):
        color = fichier.split("_")[2].split(".")[0]
        name = color + "_colorblock.png"
